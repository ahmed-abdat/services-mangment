...
export default function NoServicesFound({ serviceName} : { serviceName?: string}) {
    const uploadservesurl = "/services/upload-servers";
  return (
   <>
         <div className="mt-8">
        <div className="py-20 text-center flex flex-col items-center ">
          ...
          <p className="text-sm text-zinc-600 mt-2">
            you have not {serviceName ? 'services accounts' : 'services'} yet
          </p>
          <Link
          ...
          >
            Create New {serviceName ? 'Services Accounts' : 'Services'}
